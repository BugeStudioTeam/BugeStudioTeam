...
| :--- | :--- | :--- | :--- |
| [**Buge App Manager**](https://github.com/BugeStudioTeam/Buge-App-Manager) | 188 | Powerful Android app & permission management tool. Requires Shizuku. | `Kotlin` `Shizuku` `Android` |
