...
| :--- | :--- | :--- | :--- |
| [**Buge App Manager**](https://github.com/BugeStudioTeam/Buge-App-Manager) | 255 | Powerful Android app & permission management tool. Requires Shizuku or ROOT. | `Kotlin` `Shizuku` `Android` |
