...
| [**Buge Player**](https://github.com/BugeStudioTeam/Buge-Player) | 12 | Buge Player is a privacy-first Android media player with Material Design 3. | `Kotlin` `MediaPlayer` `Android` |
