...
| :--- | :--- | :--- | :--- |
| [**Buge App Manager**](https://github.com/BugeStudioTeam/Buge-App-Manager) | 148 | Powerful Android app & permission management tool. Requires Shizuku. | `Kotlin` `Shizuku` `Android` |
| [**Zynox**](https://github.com/BugeStudioTeam/Zynox) | 4 | AI-powered CLI tool creates files/folders from natural language across all platforms. | `Python` `CLI` `AI` |
...
[Contribute](https://github.com/BugeStudioTeam/BugeStudioTeam/blob/main/CONTRIBUTE.md)
</div>
